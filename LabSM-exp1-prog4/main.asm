...
W16_ASC:	mov		#0x0,R7					;Esvazia R7, contador de bits 0-16 para word 16bit
			mov		#0x0,R9					;Esvazia R9, R9 ̩ contador de grandeza do bit (0-4) para um nibble
...
Write:		mov		#0x0,R9					;Zerando por zer o proximo nibble
			cmp.b	#0xA,R10				;Verificando se o nibble ̩ numero ou letra para gerar ASCII
			jlo		number					;̩ numero
			jhs		char					;̩ letra
...
Exit:		mov		#0x0,R9					;novo nibble
			cmp.w	#16,R7
			jeq		BRK						;se analisou 16 bit, ̩ o fim
